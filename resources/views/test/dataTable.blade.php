...
<html lang="id" >
  <head>
    ...
    <style>
        ...
        .col-sm-12.col-md-6 .dataTables_filter{
            background-color: red;
            padding: 5px;
            border-radius: 8px;
            color: white;
        ...
        .col-sm-12.col-md-6 .dt-buttons.btn-group.flex-wrap .btn.btn-secondary{
            background-color: red;
            border: 1px solid
        }
  ...
  <body>
    ...
    <table id="example" class="table table-primary table-striped border rounded shadow " style="width:100%">
        <thead>
            <tr>
                <th>Name</th>
                <th>Position</th>
